        ...
        <div class="formPages" id="registrationTab" style="display: none">
            ...
            <div class="control-group">
                <form action="login_logout&registration/registration.php" method="post">
                    ...
                    <input class="form-control" type="text" placeholder="Name" name="name" oninvalid="alert('The password field must be filled');" required>
                    <input class="form-control" type="text" placeholder="Email Address" name="email" oninvalid="alert('The password field must be filled');" required>
                    
                    <br>
                    <div style="text-align: center;">
                        <img src="../Web_App/captcha/captcha.php" /><input class="form-control" type="text" placeholder="Enter Captcha here" name="captcha">
        ...
        <div class="formPages" id="loginTab" >
            ...
            <div class="loginPage">
                <form class="form" action="login_logout&registration/loginProcess.php" method="post">
                    ...
                    <input class="form-control" type="number" placeholder="2FA code" name="MFA_code">
                    <br />
